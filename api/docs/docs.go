...
const docTemplate = `{
        ...
        "/auth/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "FullName filter",
                        "name": "full_name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "PhoneNumber filter",
                        "name": "phone_number",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/storage.GetAllUsersRow"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "storage.GetAllUsersRow": {
            "type": "object",
            "properties": {
                "employee": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/storage.Employees"
                    }
                },
                "limit": {
                    "type": "integer"
